...
/**
 * Centraliza titulos/nomes/lores/icones de TODAS as GUIs do AlkaItems no menus.yml -
 * tudo editavel sem recompilar (R8 do CLAUDE.md). Itens sao definidos por
 * menus.yml.<caminho> com material/name/lore; placeholders passados como {chave}
 * sao substituidos na hora. Mesmo padrao ja usado em com.alkacode.clans.config.MenuConfig.
 */
public final class MenuConfig {
    ...
    /** Le uma string solta (nao um item material/name/lore) de menus.yml.<path>, com placeholders. */
    ...
    /** Lore como MiniMessage cru (sem virar Component) - usado quando o Java precisa
     * combinar linhas estaticas do YML com linhas geradas em runtime (ex: lista de
     * encantamentos custom) antes de montar o item via BaseGui#createItem. */
